      ...
      .then((result) => {
        ...
        newData.forEach((element) => {
          element.comments.filter((c) => {
            //console.log("mera comment",c.text)
        ...
        //         item.comments.filter(record=>{
        //             return record._id!=commentId
        //         })
        //     }
        //     return item
        // })
        console.log("poo", newData);
        setData(newData);
      });
  };
  ...
  return (
    ...
    {data?
      (data.length
        ...
        : <h1 className="center" style={{paddingTop:"10%"}}>Nothing to show here!</h1>)
